...
function addVacancesColor(day, month, year) { // TODO
  ...
  if(!year in years) return;
  let yearTable;
  for(let th of yearsTH) {
    console.log(th.parentNode.parentNode.parentNode);
    if(th.innerHTML == year) year = th.parentNode.parentNode.parentNode.getElementsByTagName("tbody");
  }
  console.log(year);
}
